...
## Verification ##
sText = "This is Club flow without selecting Coach and also not selecting the CASL T&C: - " + emailId
sVerificationMsg = GenericLib.verifyObjectText("CSS=h3[class='title']", "You are a Club Member!")
